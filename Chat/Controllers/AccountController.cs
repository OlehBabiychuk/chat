...
namespace Chat.Controllers
{
        ...
        public class AccountController : Controller
        {
            ...
            public async Task<ActionResult> VerifyCode(string provider, string returnUrl, bool rememberMe)
            {
                ...
                return View(new AccountViewModel.VerifyCodeViewModel { Provider = provider, ReturnUrl = returnUrl, RememberMe = rememberMe });
            }
            ...
            [AllowAnonymous]
            [ValidateAntiForgeryToken]
            public async Task<ActionResult> VerifyCode(AccountViewModel.VerifyCodeViewModel model)
            {
                if (!ModelState.IsValid)
                {
                    return View(model);
            ...
            [AllowAnonymous]
            [ValidateAntiForgeryToken]
            public async Task<ActionResult> ForgotPassword(AccountViewModel.ForgotPasswordViewModel model)
            {
                if (ModelState.IsValid)
                {
            ...
            public async Task<ActionResult> SendCode(string returnUrl, bool rememberMe)
            {
                ...
                return View(new AccountViewModel.SendCodeViewModel { Providers = factorOptions, ReturnUrl = returnUrl, RememberMe = rememberMe });
            }
            ...
            [AllowAnonymous]
            [ValidateAntiForgeryToken]
            public async Task<ActionResult> SendCode(AccountViewModel.SendCodeViewModel model)
            {
                if (!ModelState.IsValid)
                {
                    return View();
            ...
            public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
            {
                ...
                switch (result)
                {
                    ...
                    default:
                        ...
                        return View("ExternalLoginConfirmation", new AccountViewModel.ExternalLoginConfirmationViewModel { Email = loginInfo.Email });
                }
            }
            ...
            [AllowAnonymous]
            [ValidateAntiForgeryToken]
            public async Task<ActionResult> ExternalLoginConfirmation(AccountViewModel.ExternalLoginConfirmationViewModel model, string returnUrl)
            {
